...
public class CheckoutPage extends BasePage {
    ...
    private AppiumBy firstNameField = new AppiumBy.ByAccessibilityId("test-First Name");
    private AppiumBy lastNameField = new AppiumBy.ByAccessibilityId("test-Last Name");
    private AppiumBy postalCodeField = new AppiumBy.ByAccessibilityId("test-Zip/Postal Code");
    private AppiumBy continueButton = new AppiumBy.ByAccessibilityId("test-CONTINUE");
